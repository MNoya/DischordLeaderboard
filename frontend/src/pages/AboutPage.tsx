...
function Scoring() {
  return (
    <div className="flex flex-col gap-5 md:gap-6">
      <div
        className="bg-surface border border-border2 px-3 py-3 md:px-5 md:py-4 mono tracking-tight flex flex-wrap items-center gap-x-2 gap-y-1.5"
        style={{ fontSize: "clamp(9.5px, 2.6vw, 15px)" }}
      >
        <span className="whitespace-nowrap">
          <span className="text-green">POINTS</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        <div className="flex flex-col gap-2 text-[13px] md:text-[14px] text-muted leading-[1.6]">
          ...
          <p>
            Filtering by format or deck colors recalculates points for each player using only the
            matching events.
          </p>
        </div>
